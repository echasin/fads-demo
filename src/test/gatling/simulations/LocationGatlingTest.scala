...
class LocationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Location entity")
        ...
        .repeat(2) {
            ...
            .post("/api/locations")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "addressline1":"SAMPLE_TEXT", "addressline2":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "statecode":"SAMPLE_TEXT", "zippostcode":"SAMPLE_TEXT", "status":null, "lastmodifiedby":"SAMPLE_TEXT", "lastmodifieddatetime":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
