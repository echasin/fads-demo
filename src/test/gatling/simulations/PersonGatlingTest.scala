...
class PersonGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Person entity")
        ...
        .repeat(2) {
            ...
            .post("/api/people")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstname":"SAMPLE_TEXT", "lastname":"SAMPLE_TEXT", "fullname":"SAMPLE_TEXT", "status":null, "lastmodifiedby":"SAMPLE_TEXT", "lastmodifieddatetime":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
